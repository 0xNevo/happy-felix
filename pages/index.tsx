...
export default function Home() {
  ...
  const meta = {
    title: "Felix Martel ",
    description: `I am a professional Web3 Full Stack Developer with over 6 years of development experience. If you are interested in developing these products, please contact me.`,
  ...
  return (
    <>
      ...
      <div className="relative snap-mandatory min-h-screen bg-AAprimary w-full ">
        ...
        {context.sharedState.finishedLoading ? (
          <Footer
            githubUrl={"https://github.com/0xNevo"}
